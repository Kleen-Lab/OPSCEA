...
% direc: direction (anatomic) from where the light should originate. multiple ok.
% bri: brightness from 0 (none) to 1 (max)

%% Extra tips!
% 1. To delete all light sources, use lightsout.m
% 2. View inferior but rotated so that in the figure it is positioned:
...
if bri; h=set(light,'position',P,'color',bri*[1 1 1]); end
